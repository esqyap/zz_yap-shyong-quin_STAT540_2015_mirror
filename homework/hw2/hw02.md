...
```
## 'data.frame':	5705 obs. of  6 variables:
##  $ probe.id : Factor w/ 10928 levels "1769308_at","1769309_at",..: 3020 4709 4658 6704 4660 6852 1250 4608 6834 7323 ...
##  $ gene.id  : Factor w/ 5657 levels "YAL001C","YAL002W",..: 2593 5213 4299 4200 3019 1107 563 4166 5175 1943 ...
##  $ p.value  : num  9.48e-14 4.28e-13 9.93e-13 2.25e-12 2.62e-12 ...
##  $ q.value  : num  1.04e-09 2.34e-09 3.62e-09 5.72e-09 5.72e-09 ...
##  $ log.fc   : num  10.11 8.47 8.99 7.3 8.58 ...
##  $ test.stat: num  108.9 89.9 80.7 72.7 71.3 ...
```
...
```
## [1] YIL057C YOR388C
## 5657 Levels: YAL001C YAL002W YAL003W YAL005C YAL007C YAL008W ... YPR201W
```
...
```
## [1] YGR130C
## 6542 Levels: 15S_rRNA 21S_rRNA HRA1 ICR1 LSR1 NME1 Q0045 Q0050 ... YPR204W
```
...
![](hw02_files/figure-html/unnamed-chunk-37-1.png) 
...
![](hw02_files/figure-html/unnamed-chunk-41-1.png) 
...
The `edgeR` method is more robust to reduced sequencing depth because 18% of DE genes identified in the DEA of the deep sequencing depth dataset were retained in the DEA results of the low sequencing depth dataset. In contrast to the `edgeR` method, no DE genes were retained using the `voom+limma` method when sequencing depth was reduced. 
